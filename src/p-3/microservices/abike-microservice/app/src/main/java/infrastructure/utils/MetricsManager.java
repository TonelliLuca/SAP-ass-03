...
public class MetricsManager {
    ...
    public void recordTimer(Timer.Sample sample, String methodName) {
        sample.stop(Timer.builder("abike_service_method_duration")
    ...
    public void incrementMethodCounter(String methodName) {
        registry.counter("abike_service_method_calls", "method", methodName).increment();
    }
    ...
    public void recordError(Timer.Sample sample, String methodName, Throwable error) {
        sample.stop(Timer.builder("abike_service_method_duration")
                ...
                .register(registry));
        registry.counter("abike_service_method_errors", "method", methodName, "error", error.getClass().getSimpleName()).increment();
    }
}