...
public class StationVerticle extends AbstractVerticle {

    private static final Logger logger = LoggerFactory.getLogger(StationVerticle.class);

    private final RESTStationAdapter stationService;
    ...
    public StationVerticle(RESTStationAdapter stationService, Vertx vertx) {
    ...
    public void start(Promise<Void> startPromise) {
        ...
        stationService.configureRoutes(router);
